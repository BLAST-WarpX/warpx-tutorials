...
versions of the lattice. The Tutorial 2 directory contains:

- `fccee_z.madx`, the common FCC-ee lattice
- `fcc_impactx.py`, which runs the ImpactX envelope calculation
- the Tutorial 2 analysis notebook, which runs MAD-X through CPyMAD, imports
  the live MAD-X sequence into Xsuite, and compares all three results
- `fccee_z.json`, an optional serialized Xsuite version of the lattice
